...
export const V1ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async validateHaproxyConfig(haproxyConfiguration: HaproxyConfiguration, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export class V1Api extends BaseAPI implements V1ApiInterface {
    ...
    public validateHaproxyConfig(haproxyConfiguration: HaproxyConfiguration, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).validateHaproxyConfig(haproxyConfiguration, options).then((request) => request(this.axios, this.basePath));
    }
}
