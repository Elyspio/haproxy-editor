...
export default function DashboardLayout() {
	...
	return (
		...
		>
			<DashboardHeader logo={<HaproxyIcon />} title="" menuOpen={isNavigationExpanded} onToggleMenu={handleToggleHeaderMenu} />
			<SidebarDashboard expanded={isNavigationExpanded} setExpanded={setIsNavigationExpanded} container={layoutRef?.current ?? undefined} />
			<Box
				sx={{
					display: "flex",
